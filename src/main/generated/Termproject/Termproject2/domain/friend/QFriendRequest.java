...
public class QFriendRequest extends EntityPathBase<FriendRequest> {
    ...
    private static final long serialVersionUID = 307807139L;
    ...
    public final Termproject.Termproject2.domain.member.entity.QMember receiver;

    public final Termproject.Termproject2.domain.member.entity.QMember sender;
    ...
    public QFriendRequest(Class<? extends FriendRequest> type, PathMetadata metadata, PathInits inits) {
        ...
        this.receiver = inits.isInitialized("receiver") ? new Termproject.Termproject2.domain.member.entity.QMember(forProperty("receiver"), inits.get("receiver")) : null;
        this.sender = inits.isInitialized("sender") ? new Termproject.Termproject2.domain.member.entity.QMember(forProperty("sender"), inits.get("sender")) : null;
    }
