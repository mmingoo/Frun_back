...
public class QFriendship extends EntityPathBase<Friendship> {
    ...
    private static final long serialVersionUID = -310330985L;
    ...
    public final Termproject.Termproject2.domain.user.entity.QUser receiveUser;

    public final Termproject.Termproject2.domain.user.entity.QUser senderUser;
    ...
    public QFriendship(Class<? extends Friendship> type, PathMetadata metadata, PathInits inits) {
        ...
        this.receiveUser = inits.isInitialized("receiveUser") ? new Termproject.Termproject2.domain.user.entity.QUser(forProperty("receiveUser"), inits.get("receiveUser")) : null;
        this.senderUser = inits.isInitialized("senderUser") ? new Termproject.Termproject2.domain.user.entity.QUser(forProperty("senderUser"), inits.get("senderUser")) : null;
    }
